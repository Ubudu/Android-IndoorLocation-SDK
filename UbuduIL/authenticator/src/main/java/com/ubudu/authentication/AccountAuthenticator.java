...
public class AccountAuthenticator extends AbstractAccountAuthenticator {
    ...
    public static final String TAG = AccountAuthenticator.class.getCanonicalName();
    ...
    public String getAuthTokenLabel(String authTokenType) {
        if (authTokenType.equals(AccountGeneral.AUTHTOKEN_TYPE_READ_WRITE)) {
            return AccountGeneral.AUTHTOKEN_TYPE_READ_WRITE_LABEL;
        } else {
            return AccountGeneral.AUTHTOKEN_TYPE_UNKNOWN_LABEL;
        }
    }
