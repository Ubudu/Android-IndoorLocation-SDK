...
import com.ubudu.ilapp2.view.AttractorCalibrationView;
import com.ubudu.ilapp2.view.ParticleFilterConfigurationView;
import com.ubudu.ilapp2.view.TwrCalibrationView;
...
public class MapFragment extends BaseFragment implements UbuduIndoorLocationDelegate, MapLayout.EventListener, UbuduParticleFilterListener {
    ...
    @BindView(R.id.particle_filter_config)
    ParticleFilterConfigurationView pfCalibrationView;

    @BindView(R.id.attractor_calibration)
    AttractorCalibrationView attractorCalibrationView;

    @BindView(R.id.twr_calibration)
    TwrCalibrationView twrCalibrationView;
    ...
    @BindView(R.id.calibrate_user_button)
    FancyButton calibrateUserButton;
    @BindView(R.id.calibrate_pf_button)
    FancyButton calibratePfButton;
    @BindView(R.id.buttons)
    LinearLayout buttonsLayout;
    @BindView(R.id.draw_path_button)
    FancyButton drawPathButton;
    @BindView(R.id.calibrate_attractor_button)
    FancyButton calibrateAttractorButton;

    @BindView(R.id.calibrate_twr_button)
    FancyButton calibrateTwrButton;

//    @BindView(R.id.uwb_button)
//    FancyButton uwbButton;
    ...
    public void onResume() {
        ...
        int modeOfOperation = mSharedPref.getInt(MyPreferences.PREFERENCE_MODE_OF_OPERATION,0);
        if(modeOfOperation != 2 && !mIndoorLocationManager.isUwbTagConnected()) {
            calibrateAttractorButton.setVisibility(View.GONE);
            calibrateUserButton.setVisibility(View.VISIBLE);
            calibratePfButton.setVisibility(View.VISIBLE);
            calibrateTwrButton.setVisibility(View.GONE);
        } else if(!mIndoorLocationManager.isUwbTagConnected()) {
            calibrateAttractorButton.setVisibility(View.VISIBLE);
            calibrateUserButton.setVisibility(View.GONE);
            calibratePfButton.setVisibility(View.GONE);
            calibrateTwrButton.setVisibility(View.GONE);
        } else if(mIndoorLocationManager.isUwbTagConnected()) {
            calibrateAttractorButton.setVisibility(View.GONE);
            calibrateUserButton.setVisibility(View.GONE);
            calibratePfButton.setVisibility(View.GONE);
            calibrateTwrButton.setVisibility(View.VISIBLE);
        }
    }
    ...
    public void beaconsUpdated(List<ILBeacon> beacons) {
        ...
        for (Marker marker : markersMatchingTag.keySet()) {
            ...
            if(!beaconDetected) {
                final com.google.android.gms.maps.model.Marker googleMarker = markersMatchingTag.get(marker);
                final String color = "#a5c4e1";
    ...
    public void onMapReady() {
        ...
        pfCalibrationView.init(getContext());
        attractorCalibrationView.init(getContext());
        twrCalibrationView.init(getContext());

        userCalibrationView.setVisibility(View.GONE);
        pfCalibrationView.setVisibility(View.GONE);
        attractorCalibrationView.setVisibility(View.GONE);
        twrCalibrationView.setVisibility(View.GONE);

//        uwbButton.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//        });
        ...
        calibrateTwrButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(twrCalibrationView.getVisibility()==View.VISIBLE) {
                    twrCalibrationView.setVisibility(View.GONE);
                    calibrateTwrButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                } else {
                    pfCalibrationView.setVisibility(View.GONE);
                    calibratePfButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                    userCalibrationView.setVisibility(View.GONE);
                    calibrateUserButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                    attractorCalibrationView.setVisibility(View.GONE);
                    calibrateAttractorButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                    twrCalibrationView.setVisibility(View.VISIBLE);
                    calibrateTwrButton.setBackgroundColor(getResources().getColor(R.color.colorAccent));
                }
            }
        });

        calibrateAttractorButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(attractorCalibrationView.getVisibility()==View.VISIBLE) {
                    attractorCalibrationView.setVisibility(View.GONE);
                    calibrateAttractorButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                } else {
                    pfCalibrationView.setVisibility(View.GONE);
                    ...
                    userCalibrationView.setVisibility(View.GONE);
                    calibrateUserButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                    attractorCalibrationView.setVisibility(View.VISIBLE);
                    calibrateAttractorButton.setBackgroundColor(getResources().getColor(R.color.colorAccent));
                    twrCalibrationView.setVisibility(View.GONE);
                    calibrateTwrButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                }
            }
        ...
        calibrateUserButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(userCalibrationView.getVisibility()==View.VISIBLE) {
                    userCalibrationView.setVisibility(View.GONE);
                    calibrateUserButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                } else {
                    pfCalibrationView.setVisibility(View.GONE);
                    ...
                    attractorCalibrationView.setVisibility(View.GONE);
                    calibrateAttractorButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                    userCalibrationView.setVisibility(View.VISIBLE);
                    calibrateUserButton.setBackgroundColor(getResources().getColor(R.color.colorAccent));
                    twrCalibrationView.setVisibility(View.GONE);
                    calibrateTwrButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                }
            }
        ...
        calibratePfButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(pfCalibrationView.getVisibility()==View.VISIBLE) {
                    pfCalibrationView.setVisibility(View.GONE);
                    calibratePfButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                } else {
                    userCalibrationView.setVisibility(View.GONE);
                    ...
                    attractorCalibrationView.setVisibility(View.GONE);
                    calibrateAttractorButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                    pfCalibrationView.setVisibility(View.VISIBLE);
                    calibratePfButton.setBackgroundColor(getResources().getColor(R.color.colorAccent));
                    twrCalibrationView.setVisibility(View.GONE);
                    calibrateTwrButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                }
            }
        ...
        drawPathButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isPathEnabled) {
                    drawPathButton.setBackgroundColor(getResources().getColor(R.color.colorAccent));
                } else {
                    drawPathButton.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                    mMapView.removePath("path");
                }
            }
        });
